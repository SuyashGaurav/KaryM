...
<body style="background-image: url('web-design.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-size: cover;">
    ...
    <h1 style="text-align: center; margin-top: 120px; color: white;">For Customers</h1>
    <div class="container">
        <div class="login">
        ...
        <div class="login-help">
            <p style="color: white;">Don't have an account? <a href="customersignup.php">Sign up</a></p>
        </div>
    </div>
</body>
