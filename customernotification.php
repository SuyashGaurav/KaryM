...
<h1 class="HeaderDesktop"><img width = "6%" style = "float:left; margin-left: -25px; margin-top: -17px; margin-right: -15px;" src = "logo-removebg-preview.png"><a onclick = "openF()"> <img style="cursor: pointer; width: 40px; padding-right: 25px; float:right;" src="usericon.png" id="btn"></a>
    ...
    if ($conn->connect_error) {
        ...
        if(isset($_SERVER["HTTP_REFERER"]) and (strpos($_SERVER["HTTP_REFERER"], "customermain.php") or strpos($_SERVER["HTTP_REFERER"], "customermain.php"))){
            ...
            while ($row=$result->fetch_assoc()){
                        echo '<tr><td class="box-cust-req"><img src="cust-icon.png" style = "margin-left: 10px; margin-top: -3px;" width="60px"><img src="cust-location1.png" style = "margin-top: -10px; margin-right: 10px;" width="40px" align="right"><div style = "margin-left:87px; margin-top:-60px;">'.$row["LabourerName"].'<span style="float:right; font-size: 18px; font-family: courier;">'.$row["City"].'</span><br><span style="font-size: 18px;">'.$row["Address"].'<br></span><span style="font-size: 15px; font-family: Arial;">'.$row["Phone_no"].'</span></div>  <form action="customernotification.php" method="post">
            ...
            while ($row=$result1->fetch_assoc()){
                echo '<tr><td class="box-cust-req"><img src="cust-icon.png" style = "margin-left: 10px; margin-top: -3px;" width="60px"><img src="cust-location1.png" style = "margin-top: -10px; margin-right: 10px;" width="40px" align="right"><div style = "margin-left:87px; margin-top:-60px;">'.$row["ContractorName"].'<span style="float:right; font-size: 18px; font-family: courier;">'.$row["City"].'</span><br><span style="font-size: 18px;">'.$row["Address"].'<br></span><span style="font-size: 15px; font-family: Arial;">'.$row["Phone_no"].'</span></div>  <form action="customernotification.php" method="post">
                <input type="submit" class="button" value="Accept" >
