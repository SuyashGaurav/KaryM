...
INSERT INTO `contractors` (`Contractor_Id`, `ContractorName`, `Email`, `Password`, `Phone_no`, `Address`, `Plumber`, `Electrician`, `Carpenter`, `Driver`, `Babysitter`, `Maid`, `Painter`, `CleaningAndPestcontrol`) VALUES
(1, 'kogami', 'kogami@go', 'kogami', '8343241234', 'Japan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `customers` (`customerid`, `customername`, `email`, `phone_no`, `address`, `password`) VALUES
(2000, 'Erwin', 'erwin@erwin', '1231231231', 'Survey Corps, Germany', 'erwin'),
(2001, 'Levi', 'levi@levi', '1341142212', 'Underground, Germany', 'levi');
...
INSERT INTO `labourers` (`Labourer_Id`, `LabourerName`, `Email`, `Phone_no`, `Address`, `Password`, `Plumber`, `Electrician`, `Carpenter`, `Maid`, `Babysitter`, `Driver`, `CleaningAndPestcontrol`, `Painter`) VALUES
(1000, 'eren', 'eren@eren', '12312', 'germany', 'eren', 1, 1, 0, 0, 0, 0, 0, 0),
(1001, 'Guts', 'guts@guts', '1654331234', 'Midland, where blind sheep gather and erect a pillar', 'guts', 0, 1, 0, 1, 1, 0, 0, 1);
...
(2001, 'Clean my house', 0, 1, 0, 0, 0, 1, 0, 0, NULL, 2);
