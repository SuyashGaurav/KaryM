...
<a onclick = "openF()"> <img style="cursor: pointer; width: 40px; padding-right: 25px; float:right;" src="../img/../img/usericon.png" id="btn"></a>

<a href="homepage.php" style="color:#e6962d;"><a href="homepage.php" style="color:#e6962d;">KaryM</a></a>
<a href = "../img/aboutus.html"><p style="float:right; margin-right: 1.4%; margin-top: 1%; font-size:49%; color: #e6962d;">About Us</p></a>
</h1>
    ...
    if ($result2->num_rows > 0) {
        ...
        while($row = $result2->fetch_assoc()) {
            ...
            <tr>
                ...
                <img src="../img/cust-icon.png"  width="60px"><img src="../img/cust-location1.png" style = "margin-top: -10px; margin-right: 10px;" width="40px" align="right">'.
    ...
    if($select == "Plumber1"){
        if ($result2->num_rows > 0) {
            while($row = $result2->fetch_assoc()) {
                ...
                <tr>
                    <td class="box-cust-req"> 
                    <img src="../img/cust-icon.png" style = "margin-left: 10px; margin-top: -3px;" width="60px"><img src="../img/cust-location1.png" style = "margin-top: -10px; margin-right: 10px;" width="40px" align="right">'.
