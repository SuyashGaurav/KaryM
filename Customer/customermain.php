...
<script>
    ...
    if (isset($_SERVER["HTTP_REFERER"]) and strpos($_SERVER["HTTP_REFERER"], "customerlogin.php") && (isset($_POST["email"]) || isset($_SESSION["email"]))){
        echo '<h1 class="HeaderDesktop"><img width = "6%" style = "float:left; margin-left: -25px; margin-top: -11px; margin-right: -15px;" src = "../img/logo-removebg-preview.png"> 

        <a onclick = "openF()"> <img style="cursor: pointer; width: 40px; padding-right: 25px; float:right;" src="../img/usericon.png" id="btn"></a>
...
<table id = "table3" class="container">
    <tr>
      <td>
            ...
            <label for="Electrician1"><img  class = "image" style = "width: 5.5cm; height: 3cm; margin-top: 30%;" src = "../img/labourer_types/electrician.png"></label>
    ...
    <td>
            ...
            <label for="Plumber1"><img  class = "image" style = "width: 5.5cm; height:3cm; margin-top: 30%;" src = "../img/labourer_types/plumber.jpg"></label>
    ...
    <td>
            ...
            <label for="Carpenter1"><img  class = "image" style = "width: 5.5cm; height:3cm; margin-top: 30%;" src = "../img/labourer_types/carpenter.jpg"></label>
    ...
    <tr>
      <td>
            ...
            <label for="Driver1"><img  class = "image" style = "width: 5.5cm; height:3cm; margin-top: 30%;" src = "../img/labourer_types/driver.jpg"></label>
            <div style = "color: white; margin-left: 1.5cm"> Driver</div>
    </td>
    <td>
            <input type="radio" name="role" id="Painter1" value="Painter1" onclick="submitt()">
            <label for="Painter1"><img  class = "image" style = "width: 5.5cm; height: 3cm; margin-top: 30%;" src = "../img/labourer_types/painter.jpg"></label>
    ...
    <td>
            ...
            <label for="Babysitter1"><img  class = "image" style = "width: 5.5cm; height: 3cm; margin-top: 30%;" src = "../img/labourer_types/babysitter.jpg"></label>
    ...
    <tr>
      <td>
            ...
            <label for="Maid1"><img  class = "image" style = "width: 5.5cm; height:3cm; margin-top: 30%;" src = "../img/labourer_types/maid.jpg"></label>
            <div style = "color: white; margin-left: 1.5cm"> Maid</div>
    </td>
    <td>
            <input type="radio" name="role" id="Unskilled1" value="Labourer1" onclick="submitt()">
            <label for="Unskilled1"><img  class = "image" style = "width: 5.5cm; height: 3cm; margin-top: 30%;" src = "../img/labourer_types/unskilled.jpg"></label>
    ...
    <td>
            ...
            <label for="CleaningAndPestcontrol1"><img  class = "image" style = "width: 5.5cm; height: 3cm; margin-top: 30%;" src = "../img/labourer_types/pestcontrol.jpg"></label>
